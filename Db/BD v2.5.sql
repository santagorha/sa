...
CREATE TABLE COMENTARIO ( 
	...
	ID_EVENTO SMALLINT NOT NULL,
	FECHA DATE, 
	CONSTRAINT COMENTARIOS_USUARIOS FOREIGN KEY (ID_USUARIO) REFERENCES usuarios(ID_USUARIO),
	CONSTRAINT COMENTARIOS_EVENTOS FOREIGN KEY (ID_EVENTO) REFERENCES eventos(ID_EVENTO)
);

CREATE TABLE USUARIONOREGISTRADO (
	ID_USUARIONOREGISTRADO SMALLINT NOT NULL AUTO_INCREMENT PRIMARY KEY; 
	NOMBRE_USUARIO VARCHAR(25) NOT NULL PRIMARY KEY,
	ID_EVENTO SMALLINT NOT NULL,
	AGREGADO_EVENTO BOOLEAN, 
	REGISTRADO_USUARIO BOOLEAN	
);