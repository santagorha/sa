     ...
     */
DROP DATABASE APPEVENTOS;  /* Quitar esta linea si no se tiene la base antes instalada*/
...
CREATE TABLE EVENTO(
	...
	CREDITOS SMALLINT(2) DEFAULT 0,
	FECHA_PROGRAMADO DATETIME NOT NULL,
	FECHA_CREADO DATETIME DEFAULT CURRENT_TIMESTAMP,
	MARCA_ELIMINADO BOOLEAN DEFAULT FALSE,
	FECHA_ELIMINADO DATETIME DEFAULT CURRENT_TIMESTAMP,
	FECHA_EDITADO DATETIME DEFAULT CURRENT_TIMESTAMP,
	CONSTRAINT EVENTOS_SEDES FOREIGN KEY (ID_SEDE) REFERENCES SEDE (ID_SEDE),
	CONSTRAINT EVENTOS_FACULTAD FOREIGN KEY (ID_FACULTAD) REFERENCES FACULTAD (ID_FACULTAD),
	CONSTRAINT CATEGORIA_EVENTO FOREIGN KEY (ID_CATEGORIA) REFERENCES CATEGORIA (ID_CATEGORIA)
);
...
CREATE TABLE EVENTO_USUARIO (
	...
	MARCA_GUARDADO BOOLEAN NOT NULL DEFAULT FALSE,
	MARCA_FAVORITO BOOLEAN NOT NULL DEFAULT FALSE,
	MARCA_EVENTO_ELIMINADO_USUARIO BOOLEAN NOT NULL DEFAULT FALSE,
	FECHA_EVENTO_ELIMINADO_USUARIO DATETIME DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE SESION (
	ID_SESION VARCHAR(50) NOT NULL PRIMARY KEY,
	ID_USUARIO SMALLINT NOT NULL,
