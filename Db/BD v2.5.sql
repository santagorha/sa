...
CREATE TABLE COMENTARIO ( --FALTA POBLAR
...
CREATE TABLE NOTIFICACION (  --FALTA POBLAR
...
ALTER MARCA_GUARDADO SET DEFAULT FALSE; 

ALTER TABLE EVENTO_USUARIO
ALTER MARCA_FAVORITO SET DEFAULT FALSE; 
