...
(1, 'ASESORIA MATEMATICAS', '2017/12/7', 'img.JPG', 'TEMAS DE REPASO: ALGEBRA BASICA Y TRIGONOMETRIA', 'DESCRIPCION X', 'categoria INGENIERIA', 1, 'SALON 3', 15, '1.5', 3, 2, '2017/10/09', '2017/10/07', 0, now(), '2017/10/09'),
(2, 'ASESORIA PROGRAMACION', '2017/10/10', 'img45.JPG', 'TEMAS DE REPASO: PHP Y SQL', 'DESCRIPCION Y', 'categoria INGENIERIA', 2, 'SALON 101', 8, '2.4', 1, 0, '2017/10/09', '2017/10/07', 0, now(), '2017/10/18'),
(3, 'ASESORIA DIBUJO', '2017/8/1', 'img4234343243.JPG', 'TEMAS DE REPASO: TRAZO Y COLOR', 'DESCRIPCION Z', 'categoria ARTES', 1, 'SALON DIBUJO', 10, '3', 2, 2, '2017/10/09', '2017/10/07', 0, now(), '2017/10/23');
