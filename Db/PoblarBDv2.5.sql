...
(1, 'ASESORIA MATEMATICAS', '2017/12/7', 'img.JPG', 'TEMAS DE REPASO: ALGEBRA BASICA Y TRIGONOMETRIA', 'DESCRIPCION X', 'categoria INGENIERIA', 1, 'SALON 3', 15, '1.5', 3, 2, '2017/10/09', '2017/10/07', 0, '2017/10/09'),
(2, 'ASESORIA PROGRAMACION', '2017/10/10', 'img45.JPG', 'TEMAS DE REPASO: PHP Y SQL', 'DESCRIPCION Y', 'categoria INGENIERIA', 2, 'SALON 101', 8, '2.4', 1, 0, '2017/10/09', '2017/10/07', 0, '2017/10/18'),
(3, 'ASESORIA DIBUJO', '2017/8/1', 'img4234343243.JPG', 'TEMAS DE REPASO: TRAZO Y COLOR', 'DESCRIPCION Z', 'categoria ARTES', 1, 'SALON DIBUJO', 10, '3', 2, 2, '2017/10/09', '2017/10/07', 0, '2017/10/23');
...
(1, 4, 1, 0, 'ASISTENTE', 0, 1, 0, '2017/10/09'),
(2, 1, 3, 1, 'ASISTENTE', 1, 1, 0, '2017/12/09'), 
(3, 2, 1, 0, 'ASISTENTE', 1, 0, 0, '2017/01/09'), 
(4, 2, 2, 1, 'ASISTENTE', 0, 0, 0, '2017/05/09'), 
(5, 3, 1, 1, 'ASISTENTE', 1, 1, 0, '2017/07/09');
