    /*
     * Version de la base de datos: 2.4
...
CREATE TABLE INFO(
	ID_INFO SMALLINT(2) NOT NULL AUTO_INCREMENT  PRIMARY KEY,
...
CREATE TABLE SEDE (
	...
	CONSTRAINT SEDES_CIUDADES FOREIGN KEY (CIUDAD) REFERENCES CIUDAD(ID_CIUDAD)
);
...
>>>>>>> f73a594505d7d53dfdeabfac09ba392ca12061cc
